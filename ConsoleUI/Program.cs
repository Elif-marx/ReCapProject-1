...
namespace ConsoleUI
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine(result_1.Data);
        ...
        ////Müşteri Ekleme:
        //Console.WriteLine("_// Customer Add \\_:");
        //Console.WriteLine("User Id: ");
        //int cUserId = Int16.Parse(Console.ReadLine());
        //Console.WriteLine("Company Name:");
        //string cCompanyName = Console.ReadLine();

        //CustomerManager customerManager = new CustomerManager(new EFCustomerDal());
        //customerManager.Add(new Customer { UserId = cUserId, CompanyName = cCompanyName });
